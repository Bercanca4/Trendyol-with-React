  ...
  return (
    <div className="w-full h-[64px] flex justify-between items-center relative ">
        ...
        <div className="relative flex items-center justify-center rounded-md  ">
            <input className="w-[598px] h-[43px] bg-[#F3F3F3] placeholder:opacity-50 type-text pl-4 rounded-md border-none placeholder:items-center placeholder:pl-4  placeholder:text-[#333] placeholder:text-[14px]" placeholder="Aradığınız ürün, kategori veya markayı yazınız"/>
        ...
        <div className="items-center flex gap-x-8 f ">
         ...
         <label className="text-[12px] group-hover:cursor-pointer group-hover:text-orange-500">Giriş Yap</label>
         </div>
